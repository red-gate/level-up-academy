...
public class BerlinClockFormatterTests
{
    ...
    public void CheckFormatFiveMinutesIsCorrect(string time, string expected) => _berlinClockFormatter.FormatFiveMinutes(TimeOnly.Parse(time)).Should().Be(expected);
    ...
    public void CheckFormatFiveHoursIsCorrect(string time, string expected) => _berlinClockFormatter.FormatFiveHours(TimeOnly.Parse(time)).Should().Be(expected);
